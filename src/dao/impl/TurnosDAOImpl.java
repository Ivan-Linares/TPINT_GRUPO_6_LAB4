...
public class TurnosDAOImpl implements ITurnosDAO{
	...
	public boolean modificarTurno(Turnos turno) {
		...
		try {
			...
			statement.setDate(1, (Date) turno.getFecha());
